...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    VITE_SENTRY_ORG: import.meta.env.VITE_SENTRY_ORG ?? process.env.VITE_SENTRY_ORG,
    VITE_SENTRY_PROJECT: import.meta.env.VITE_SENTRY_PROJECT ?? process.env.VITE_SENTRY_PROJECT,
  },
